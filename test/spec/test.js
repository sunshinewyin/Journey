...
// (function () {
//     describe('An app model', function () {
...
//         var MOCK_GET_DATA = [
//           {position_id: 1, position_name: "Software Engineer"},
//           {position_id: 2, position_name: "Product Manager"}
//         ];
...
//         expect(_.isEmpty(app.attributes)).toEqual(false);
//         expect(app.get('availablePositions')).toBeDefined();
...
describe('The App Model', function() {
  var MOCK_GET_DATA = [
    {position_id: 1, position_name: "Software Engineer"},
    {position_id: 2, position_name: "Product Manager"}
  ];
