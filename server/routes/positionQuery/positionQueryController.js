...
module.exports = {
    ...
    getPositionsForFilter: function(request, response) {
            ...
            db.knex
                ...
                .then(function(data) {
                    ...
                    for (var positionID in tempObj) {
                        ...
                        var positionToAdd = {};
                        positionToAdd[key] = parseInt(val);

                        fromPositions.push(positionToAdd);
                    }
                    ...
                    var getExperienceStats = function(getExperienceStatsCB) {
                        ...
                        db.knex.from('expMilestones')
                            ...
                            .then(function(data) {
                                ...
                                console.log('data returned from getExperienceStats', data);
    ...
    getFilterOnPosition: function(request, response) {
        var positionID = request.query.positionID, //positionID: TO FIELD
            filterID = request.query.filterID; //filterID: FROM FIELD
